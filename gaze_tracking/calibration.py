""" (ref) https://github.com/antoinelame/GazeTracking/blob/master/gaze_tracking/calibration.py
"""
import cv2 
import numpy as np 
...
class Calibration(object):
    """ This class calibrates the pupil detection algorithm 
        by finding the best binarization threshold value for the person and the webcam.
    """
    ...
    @staticmethod
    def iris_size(frame:np.ndarray):
    ...
    @staticmethod
    def find_best_threshold(eye_frame:np.ndarray):
        """Calculates the optimal threshold to binarize the frame for the given eye.

            Argument:
                eye_frame : Frame of the eye to be analyzed
        """
